                    ...
                    <div class="card shadow-lg border-0 rounded-lg mt-4 mb-3">
                        <div class="card-header">
                            <div class="pg__name float-left">
                                <h4 class="font-weight-light my-1">Add New Reporter</h4>
                            </div>
                            <div class="pg__btn float-right">
                                <a href="{{ route('reporter.index') }}" class="btn btn__view">View All</a>
                            </div>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label for="designation">Designation <span
                                        ...
                                        <input class="form-control" type="text" name="designation"
                                               ...
                                               autocomplete="off" required>
                                        <span
                                            class="text-danger">{{ $errors->has('designation') ? $errors->first('designation'):''}}</span>
                                </div>
                                <div class="form-group">
