                ...
                <div class="card mb-4">
                    <div class="card-header">
                        <div class="pg__name float-left">
                            <h4 class="font-weight-light my-1">Add New Survey</h4>
                        </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="input-group date">
                                        <input name="start_date" required="" id="start" type="text"
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="input-group date">
                                        <input name="end_date" data-provide="datepicker" value=""
                                               data-date-format="yyyy-mm-dd" required="" id="end" type="text"
                                               class="form-control datepicker">
                                        <div class="input-group-addon">
                                            <span class="glyphicon glyphicon-th "></span>
                                        </div>
