                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="card shadow-lg rounded-lg mt-2 mb-5">
                            <div class="card-header"><h4 class="text-center font-weight-light my-2">Show Schedule
                                    Post</h4>
                            </div>
                            <div class="card-body">
                                <div class="form-group">
                                    <label>Headline <span class="text-danger">*</span></label>
                                    <input readonly name="headline" value="{{ old('headline') ?? $post->headline }}"
                                           type="text" maxlength="250" class="form-control" required>
                                    @error('headline')
                                ...
                                <div class="form-group">
                                    ...
                                    <input readonly name="sub_headline"
                                           value="{{ old('sub_headline') ?? $post->sub_headline}}" type="text"
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea readonly name="excerpt" maxlength="400" rows="5" class="textarea"
                                ...
                                <div class="form-group body__edit">
                                    ...
                                    <textarea readonly id="post_content" name="post_content"
                                              class="form-control my-editor"
                                              rows="15">{{ old('post_content') ?? $post->post_content }}</textarea>
                                    <script>
                                        var editor_config = {
                                            path_absolute: "/",
                        ...
                        <div class="card shadow-lg rounded-lg mt-2 mb-5">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-4">
                                        <label>Is Lead?</label>
                                        <input readonly type="checkbox" id="sticky" value="{{ old('sticky') ?? 1 }}"
                                               name="sticky" @if($post->sticky == 1) checked="checked" @endif>
                                        <?php $leadpost = \App\Models\LeadPost::where('post_id', $post->id)->first(); ?>
                                        <div @if($post->sticky == 1)  @else style="display:none;"
                                             @endif id="sticky_position_input">
                                            <label style="display: flex;">
                                                <input readonly id="sticky_position" type="number"
                                                       @if($leadpost) value="{{ old('sticky_position') ?? $leadpost->position }}"
                                                       @endif name="sticky_position" placeholder="Position"
                                                       style="width: 100%;border: 1px solid #ccc;padding: 5px 10px;border-radius: 4px;margin-top: 6px;">
                                            </label>
                                        </div>
                                        <?php unset($leadpost) ?>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <label>RSS</label>
                                        <input readonly type="checkbox" id="rss" name="rss"
                                               value="{{ old('rss') ?? $post->rss }}"
                                               @if($post->rss == 1) checked="checked" @endif>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input readonly id="feature_thumbnail"
                                                       class="form-control pmanager-input-field" type="text"
                                                ...
                                                <span class="input-group-btn pmanagerModal" id="featureImage"> <a
                                                        ...
                                                        class="btn btn-primary height"
                                                        style="padding:8px 13px;height: 44px;font-size: 16px;border-bottom-left-radius: 0;border-top-left-radius: 0;">Choose</a></span>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input readonly name="featured_image_caption"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input readonly name="publisher_name"
                                                   value="{{ old('publisher_name') ?? $post->publisher_name }}"
                                                   type="text" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group ui-front">
                                            <label for="title">Keywords <span class="text-danger">(Do not use # ! @ / " ' in this field)</span></label>
                                            <input readonly type="text" id="myTags" name="tag_list"
                                                   value="{{ $tag_list }}" class="form-control ">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="category_list"> Category <span
                                                            class="text-danger">*</span></label>
                                                    <select readonly class="form-control" id="category_list"
                                                            name="category_id" required>
                                                        <option value="{{ $category_id }}"
                                                                selected>{{ category_name($category_id) }}</option>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select readonly class="form-control" id="sub_cat_list"
                                                            name="sub_category_id">
                                                        <option value="">--Select Sub Category--</option>
                                                        <option value="{!! $post->sub_category_id !!}"
                                                                selected>{{ sub_category_name($sub_category_id) ?? '' }}</option>
                                                    </select>
                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-md-4">
                                                ...
                                                <select readonly class="form-control" id="division_list"
                                                        name="division_id">
                                                    <option value="{!! $post->division_id !!}"
                                                            selected>{{ division_name($division_id) }}</option>

                                                    @foreach($divisions as $division)
                                                        <option
                                                            value="{{$division->id}}" {{ $division->id == old('division_id') ? 'selected' : '' }}>
                                                            {{$division->name}}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <select readonly class="form-control" id="district_list"
                                                        name="district_id">
                                                    <option value="{!! $post->district_id !!}"
                                                            selected>{{ district_name($district_id) }}</option>
                                                </select>
                                                @error('district_id')
                                                <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <select readonly class="form-control" id="upazila_list"
                                                        name="upazila_id">
                                                    <option value="{!! $post->upazila_id !!}"
                                                            selected>{{ upazila_name($upzila_id) }}</option>
                                                </select>
                                                @error('upazila_id')
                                                <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            ...
                                            <div class="col-md-6" id="publish_time_wrapper">
                                                <div class="form-group">
                                                    ...
                                                    <input readonly type="datetime-local" id="publish_time"
                                        ...
                                        <div class="form-group btn__create">
                                            <div class="mt-4 mb-0">
                                                <a href="{{ route('post.schedule') }}" class="btn btn-danger submit">Cancel</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
