                ...
                <div class="col-lg-6">
                    <div class="card shadow-lg border-0 rounded-lg mt-3 mb-3">
                        <div class="card-header">
                            <h4 class="text-center font-weight-light my-2">View Date Wise Report</h4>
                        </div>
                        <div class="card-body">
                            <h4 class="mt-0" style="padding-bottom:0.375rem;color:#495057;text-align:center;">
                                @if (!empty($start_date))
                            ...
                            <div class="dateSearch mb-4" id="dateSrcBox">
                                <form class="form-sub" action="{{ route('date.wise.view') }}" method="get" id="date-form">
                                    <input id="reportrange" class="form-control" style="height: 36px;" type="text"
                                        name="date" required="" placeholder="date to date search">
