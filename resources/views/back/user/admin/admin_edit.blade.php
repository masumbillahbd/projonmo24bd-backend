        ...
        <div class="card shadow-lg border-0 rounded-lg mt-4 mb-3">
          ...
          <div class="card-body">
            <form role="form" method="post" action="{{ route('admin.update',['id'=>$admin->id]) }}" enctype="multipart/form-data">
              ...
              <div class="form-group row">
                <label class="col-md-3" for="position">Position <span class="text-danger">*</span></label>
                <div class="col-md-9">
                  <input  class=" form-control" name="position" value="{{$admin->position}}" placeholder="Position" min="1" type="number" required>
              ...
              <div class="form-group row">
                <label class="col-md-3" for="photo">Photo <small>(200x200)</small> {{$admin->photo}} <span class="text-danger"></span></label>
                <div class="col-md-9">

                  <div class="image-uploader">
                    <label for="imageFile" class="image-uploader__label">
                        <img src="{{ !empty($admin->photo) ? asset('/profile/'.$admin->photo) : asset('/defaults/default3.png') }}" alt="Preview image"
