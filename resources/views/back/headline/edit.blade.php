    ...
    <div class="row justify-content-center">  
      ...
      <div class="col-lg-10">
        <div class="card shadow-lg border-0 rounded-lg mt-4 mb-3">
          <div class="card-header"><h4 class="text-center font-weight-light my-1">Edit Headline</h4></div>          
          <div class="card-body">
            <form role="form" name="headline" method="post" action="{{ route('headline.update',['id'=>$headline->id]) }}" enctype="multipart/form-data">
              @csrf

              <div class="form-group">
                  <label class="mb-1">Content</label>
                  <script src="https://cdnjs.cloudflare.com/ajax/libs/tinymce/4.9.11/tinymce.min.js"></script>
                  <textarea id="post_content" name="title" class="form-control my-editor" rows="15">{{ $headline->title }}</textarea>
                  <script>
                      var editor_config = {
                          path_absolute: "/",
